<template>
    <div class="container">
        ...
        <div class="article">
            ...
            <GitHubCard
                    title="🔑 我的 网页主站项目"
                    link="https://github.com/Junior125306/zz-yy.top"
                    :info="dotfilesInfo"
                    :loading="loading"
            >
                <p>网站首页，来源见fork，我会把平时做的一些工具和项目的入口放在这里</p>
            </GitHubCard>
            <GitHubCard
                    title="📃 我的博客项目"
                    link="https://github.com/Junior125306/Junior-blog"
                    :info="dotfilesInfo"
                    :loading="loading"
            >
                <p>博客来源见fork，我会在原有的基础上用我学习的东西添加内容</p>
            </GitHubCard>
            <GitHubCard
                    title="👨‍💻 力扣刷题项目"
                    link="https://github.com/Junior125306/algorithm"
                    :info="dotfilesInfo"
                    :loading="loading"
            >
                <p>每次做完的题都会提交到项目上，并发表题解</p>
            </GitHubCard>
